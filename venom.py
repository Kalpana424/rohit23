...
TOKEN = '7419595455:AAGZstA7H7FZakPGw9gtVbF9THWbI3bqZYQ'
...
FORWARD_CHANNEL_ID = -1002190860989
CHANNEL_ID = -1002190860989
error_channel_id = -1002190860989
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/amoryesports*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin @rishabgupta01*", parse_mode='Markdown')
    else:
